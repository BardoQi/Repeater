 ...
 */
public class TextViewFlat extends TextView {
    // 散开波纹类型
    ...
    public static final int DELAY_CLICK = 1;
    ...
    public TextViewFlat(Context context, AttributeSet attrs, int defStyle) {
        ...
        setClickMode(a.getInt(R.styleable.ImageViewFlat_flat_click, DELAY_CLICK));
        a.recycle();
    }

    public TextViewFlat(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TextViewFlat(Context context) {
        this(context, null, 0);
    }

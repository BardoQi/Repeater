...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                ...
                mOffsetHeight = ta.getDimension(R.styleable.SlidingUpPanelLayout_offsetHeight, 0f);
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child == mSlideableView) {
                mSlideRange = height - mPanelHeight - (int) mOffsetHeight;
            }
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (dx * dx + dy * dy < slop * slop &&
                    ...
                    if (!isPanelExpanded() && !isPanelAnchored()) {
                        ...
                        Loger.i(this, "expandPanel");
                    } else {
                        collapsePanel();
                        Loger.i(this, "collapsePanel");
                    }
                    break;
                }
                break;
    ...
    private void inChildRect(PointF pointF) {
    ...
    private boolean isDragViewUnder(int x, int y) {
        ...
        Rect outRect = new Rect();
        dragView.getDrawingRect(outRect);
        int[] parentLocation = new int[2];
        this.getLocationOnScreen(parentLocation);
        outRect.top += mOffsetHeight;
        outRect.bottom += mOffsetHeight;
